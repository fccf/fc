...
module hdf5_interface
  ...
  contains
    ...
    procedure, public :: open_file  => hdf_open_file
    procedure, public :: close_file => hdf_close_file

    procedure, public :: open_group  => hdf_open_group
    procedure, public :: close_group => hdf_close_group

    procedure, public :: writeattr
...
contains
  !=============================================================================
  subroutine hdf_initialize(self)
  ...
  !=============================================================================
  subroutine hdf_open_file(self,filename,status,action,comp_lvl)
    !< Opens hdf5 file
  ...
  !=============================================================================
  subroutine hdf_close_file(self)
    class(hdf5_file), intent(in) :: self
    integer :: ierr

    !> close hdf5 file
    call h5fclose_f(self%lid, ierr)
    if (ierr /= 0) error stop 'Error: HDF5 close failed: '//self%filename
